 ...
 * <p>Usage: java huffmanAlgorithm.AdaptiveHuffmanCompress InputFile OutputFile</p>
 * <p>Then use the corresponding "huffmanAlgorithm.AdaptiveHuffmanDecompress" application to recreate the original input file.</p>
...
public final class AdaptiveHuffmanCompress {
	...
	public static void main(String[] args) throws IOException {
		...
		if (args.length != 2) {
			System.err.println("Usage: java huffmanAlgorithm.AdaptiveHuffmanCompress InputFile OutputFile");
			System.exit(1);
			return;
		}
