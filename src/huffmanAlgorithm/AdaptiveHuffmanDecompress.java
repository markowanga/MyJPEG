 ...
 * <p>Usage: java huffmanAlgorithm.AdaptiveHuffmanDecompress InputFile OutputFile</p>
 * <p>This decompresses files generated by the "huffmanAlgorithm.AdaptiveHuffmanCompress" application.</p>
 */
public final class AdaptiveHuffmanDecompress {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args.length != 2) {
            System.err.println("Usage: java huffmanAlgorithm.AdaptiveHuffmanDecompress InputFile OutputFile");
            System.exit(1);
            return;
        }
